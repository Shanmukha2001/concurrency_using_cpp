...
// two people trying to acquire locks of both payer and payee's accounts before transferring amount
// but both are trying to send the amount at once leading to both locks and no progress --> deadlock
